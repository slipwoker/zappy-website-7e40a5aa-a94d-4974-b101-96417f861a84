document.addEventListener('DOMContentLoaded', function () {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (submitBtn) {
        ...
        if (submitBtn.tagName === 'BUTTON') {
          ...
          submitBtn.value = submitBtn.dataset.loadingText || 'Sending...';
        }
  ...
  const animatedEls = document.querySelectorAll(
    '.fade-in, .slide-up, .slide-in, [data-animate]'
  );
  ...
  if (staggerContainers.length > 0) {
          ...
          if (entry.isIntersecting) {
            ...
            Array.from(children).forEach(function (child, index) {
              setTimeout(function () {
                ...
                child.classList.remove('pre-animate');
              }, index * staggerDelay);
            });
    ...
    staggerContainers.forEach(function (container) {
      Array.from(container.children).forEach(function (child) {
        child.classList.add('pre-animate');
      });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עד שלא נשאר כלום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7e40a5aa-a94d-4974-b101-96417f861a84',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7e40a5aa-a94d-4974-b101-96417f861a84';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7e40a5aa-a94d-4974-b101-96417f861a84';
